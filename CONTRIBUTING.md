Contributing to Concordia Cash
============================

The Concordia Cash project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the Concordia Cashunit tests or QA tests
...
The following applies to code changes to the Concordia Cash project, and is not to be
confused with overall Concordia Network Protocol consensus changes.

Whether a pull request is merged into Concordia Cash rests with the project merge
...
Patches that change Concordia consensus rules are considerably more involved than
...
Where a patchset proposes to change the Concordia consensus, it must have been
...
The project leader is the release manager for each Concordia Cash release.
