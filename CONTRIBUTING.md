Contributing to Concordia Core
============================

The Concordia Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the Concordia Coreunit tests or QA tests
...
The following applies to code changes to the Concordia Core project, and is not to be
confused with overall Concordia Network Protocol consensus changes.

Whether a pull request is merged into Concordia Core rests with the project merge
...
The project leader is the release manager for each Concordia Core release.
