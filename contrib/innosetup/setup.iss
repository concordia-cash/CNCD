...
#define MyAppName "Concordia Cash"
...
DefaultDirName={autopf}\Concordia
...
OutputDir=.\output
OutputBaseFilename=ConcordiaSetup
...
DefaultGroupName=Concordia Cash
...
[Files]
Source: ".\package\concordia-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Concordia\Concordia-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Concordia\Concordia-Qt,strDataDir|{userappdata}\Concordia\}');
  Result := True;
end;
