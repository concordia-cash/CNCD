...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Concordia concordia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  concordia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded concordia transaction") + "\n" +
                               "  concordia-tx [options] -create [commands]   " + _("Create hex-encoded concordia transaction") + "\n" +
                               "\n";
