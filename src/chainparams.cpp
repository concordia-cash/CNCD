...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000095e24c9de08faea91e7dcafda400edcd769c0a4201081966f10bdef7896")) // Genesis
; 
...
public:
    CMainParams()
    {
        ...
        consensus.nFutureTimeDriftPoS = 14;
        consensus.nMaxMoneyOut = 9999999999 * COIN;
        consensus.nStakeMinDepth = 600;
        consensus.nTargetTimespan = 30 * 60;
        consensus.nTargetSpacing = 1 * 60;
        consensus.nTimeSlotLength = 15;
        consensus.nRewardAdjustmentInterval = 10000;
        ...
        vSeeds.push_back(CDNSSeedData("seeder", "seeder.concordia.cash"));
	    vSeeds.push_back(CDNSSeedData("seed1", "seed1.concordia.cash"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.concordia.cash"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.concordia.cash"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.concordia.cash"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.concordia.cash"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.concordia.cash"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.concordia.cash"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.concordia.cash"));
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.concordia.cash", true));
