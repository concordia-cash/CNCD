...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "concordia.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for concordia.lnk
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the concordia app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add concordia app to startup item list
