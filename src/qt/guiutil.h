...
/** Utility functions used by the Concordia Qt UI.
 */
namespace GUIUtil
{
...
// Render __DSW__ addresses in monospace font
...
// Parse "__decenomy__:" URI into recipient object, return true on successful parsing
