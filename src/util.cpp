...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\concordia
// Windows >= Vista: C:\Users\Username\AppData\Roaming\concordia
// Mac: ~/Library/Application Support/concordia
// Unix: ~/.concordia
#ifdef WIN32
    // Windows
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty concordia.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override concordia.conf
