...
typedef boost::unordered_flat_map<COutPoint, CCoinsCacheEntry, SaltedOutpointHasher> CCoinsMap;
...
// Concordia: It assumes that overwrites are never possible due to BIP34 always in effect
