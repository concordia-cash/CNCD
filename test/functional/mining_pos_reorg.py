...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected CNCD supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check CNCD supply at the beginning
        # ------------------------------------------
        # CNCD supply: block rewards minus burned fees for minting
        ...
        # Verify that CNCD supplies were properly updated after the spends and reorgs
        self.log.info("Check CNCD supply...")
